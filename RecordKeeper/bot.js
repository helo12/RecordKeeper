...
client.on("message", message => {
    ...
    function runCSV() {
        ...
        var roleNickName = message.guild.roles.map(member => member.nickName).slice(1);
        for (var l = 0; l < roleIDArr.length; l++) {
            csvRole(roleIDArr[l], roleNamesArr[l], roleNickName[l]);
            console.log(roleIDArr[l] + ": " + roleNamesArr[l] + ": " + roleNickName[l]);
        }
        setTimeout(function () {
